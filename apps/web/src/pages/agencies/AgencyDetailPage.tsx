...
export function AgencyDetailPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <AdminNotesCard entity="agency" id={id!} legacyNote={agency.notes ?? null} legacyTag="Imported" legacySource="Nowsta" />
        <ActivityLogCard entity="agency" id={id!} />
      </div>

      {/* Status */}
      <DeactivateCard entity="agency" id={id!} isActive={isActive} />
    </div>
  );
}
